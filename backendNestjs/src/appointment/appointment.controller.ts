...
export class AppointmentController {
    ...
    async getMyAppointments(@Req() req: any) {
        return this.appointmentService.findByPatient(req.user.name);  //pass the req.user.email(is ly kih agr kise na kise or ka ly book krana ho to pir os ka ly email lekna lazmi.)
    }
}
